...
app.layout = html.Div([
    html.H1("FIFA World Cup Winners", style={"textAlign": "center", "color": "#2c3e50"}),
    
    dcc.Graph(id="choropleth-map"),
    
    html.Label("Select a Country:", style={"marginTop": "20px", "fontSize": "16px", "fontWeight": "bold"}),
    dcc.Dropdown(
    ...
    html.Div(id="country-output", style={"margin": "10px", "fontWeight": "bold", "fontSize": "14px"}),

    html.Label("Select a Year:", style={"marginTop": "20px", "fontSize": "16px", "fontWeight": "bold"}),
    dcc.Dropdown(
    ...
    html.Div(id="year-output", style={"margin": "10px", "fontWeight": "bold", "fontSize": "14px"})
